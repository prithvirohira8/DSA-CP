...
public class Prototype {
    public static void main(String[] args) {
        ...
        // Use the prototype to create a new shape (a red circle). (protoype would be
        // created by cloning)
...
// Key Points: To be used when creating new objects and setting its values is
// more complex than cloning