...
// However this for lop will take an additional O(n) time to find the closest node.
...
class Solution
{
    ...
    static int[] dijkstra(int V, ArrayList<ArrayList<ArrayList<Integer>>> adj, int S)
    {
        ...
        // Creating priority queue with the priority being given to vertices with min cost from source
...
// The priority queue iterates passes over all the edges and log(V) is the time complexity of
